...
namespace VRStandardAssets.Utils
{
    ...
    public class Reticle : MonoBehaviour
    {
        ...
        public void SetPosition ()
        {
			...
			m_ReticleTransform.localScale = m_OriginalScale / cameraTransform.parent.parent.localScale.x * m_DefaultDistance;
        ...
        public void SetPosition (RaycastHit hit) 
        {
			...
			m_ReticleTransform.localScale = m_OriginalScale / cameraTransform.parent.parent.localScale.x * hit.distance;
